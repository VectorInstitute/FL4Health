...
# Usage:
#
#  ./research/cifar10/adaptive_pfl/mrmtl/run_hp_sweep.sh \
#   path_to_config.yaml \
...
#   research/cifar10/adaptive_pfl/mrmtl \
#   /datasets/cifar10 \
  ...
  do
    ...
    do
      ...
      do
        ...
        SBATCH_COMMAND="research/cifar10/adaptive_pfl/mrmtl/run_fold_experiment.slrm \
          ${SERVER_CONFIG_PATH} \
