...
# Usage:
#
#  ./research/cifar10/adaptive_pfl/fedprox/run_hp_sweep.sh \
#   path_to_config.yaml \
...
# Example:
# ./research/cifar10/adaptive_pfl/fedprox/run_hp_sweep.sh \
#   research/cifar10/adaptive_pfl/fedprox/config.yaml \
#   research/cifar10/adaptive_pfl/fedprox/ \
#   /datasets/cifar10 \
  ...
  do
    ...
    do
      ...
      do
        ...
        SBATCH_COMMAND="research/cifar10/adaptive_pfl/fedprox/run_fold_experiment.slrm \
          ${SERVER_CONFIG_PATH} \
