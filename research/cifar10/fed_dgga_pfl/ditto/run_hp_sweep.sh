...
# Usage:
#
#  ./research/cifar10/fed_dgga_pfl/ditto/run_hp_sweep.sh \
#   path_to_config.yaml \
...
# Example:
# ./research/cifar10/fed_dgga_pfl/ditto/run_hp_sweep.sh \
#   research/cifar10/fed_dgga_pfl/ditto/config.yaml \
#   research/cifar10/fed_dgga_pfl/ditto \
#   /datasets/cifar10 \
  ...
  do
    ...
    do
      ...
      do
        ...
        SBATCH_COMMAND="research/cifar10/fed_dgga_pfl/ditto/run_fold_experiment.slrm \
          ${SERVER_CONFIG_PATH} \
