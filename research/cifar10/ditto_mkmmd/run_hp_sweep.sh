...
# Usage:
#
#  ./research/cifar10/ditto_mkmmd/run_hp_sweep.sh \
#   path_to_config.yaml \
...
# Example:
# ./research/cifar10/ditto_mkmmd/run_hp_sweep.sh \
#   research/cifar10/ditto_mkmmd/config.yaml \
#   research/cifar10/ditto_mkmmd \
#   /datasets/cifar10 \
      ...
      do
        ...
        do
          ...
          do
            ...
            do
            EXPERIMENT_NAME="lr_${LR_VALUE}_beta_${BETA_VALUE}_lam_${LAM_VALUE}_mu_${MU_VALUE}_l2_${L2_VALUE}_depth_${MKMMD_LOSS_DEPTH}_interval_${BETA_INTERVAL}"
            ...
            SBATCH_COMMAND="research/cifar10/ditto_mkmmd/run_fold_experiment.slrm \
              ${SERVER_CONFIG_PATH} \
