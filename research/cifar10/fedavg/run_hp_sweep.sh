...
# Example:
# ./research/cifar10/fedavg/run_hp_sweep.sh \
#   research/cifar10/fedavg/config.yaml \
#   research/cifar10/fedavg \
#   /datasets/cifar10 \
...
for LR_VALUE in "${LR_VALUES[@]}"; do
  ...
  do
    EXPERIMENT_NAME="lr_${LR_VALUE}_mu_${BETA_VALUE}"
    ...
    SBATCH_COMMAND="research/cifar10/fedavg/run_fold_experiment.slrm \
      ${SERVER_CONFIG_PATH} \
