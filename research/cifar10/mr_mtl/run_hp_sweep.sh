...
# Usage:
#
#  ./research/cifar10/mr_mtl/run_hp_sweep.sh \
#   path_to_config.yaml \
...
# Example:
# ./research/cifar10/mr_mtl/run_hp_sweep.sh \
#   research/cifar10/mr_mtl/config.yaml \
#   research/cifar10/mr_mtl \
#   /datasets/cifar10 \
...
for BETA_VALUE in "${BETA_VALUES[@]}"; do
  echo "Creating folder for alpha beta ${BETA_VALUE}"
  ...
  do
    ...
    do
      ...
      SBATCH_COMMAND="research/cifar10/mr_mtl/run_fold_experiment.slrm \
        ${SERVER_CONFIG_PATH} \
