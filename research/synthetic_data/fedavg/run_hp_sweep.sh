...
# Example:
# ./research/synthetic_data/fedavg/run_hp_sweep.sh \
#   research/synthetic_data/fedavg/config.yaml \
#   research/synthetic_data/fedavg \
...
for ALPHA_BETA_VALUE in "${ALPHA_BETA_VALUES[@]}"; do
  ...
  do
    EXPERIMENT_NAME="lr_${LR_VALUE}_alpha_beta_${ALPHA_BETA_VALUE}"
    ...
    SBATCH_COMMAND="research/synthetic_data/fedavg/run_fold_experiment.slrm \
      ${SERVER_CONFIG_PATH} \
