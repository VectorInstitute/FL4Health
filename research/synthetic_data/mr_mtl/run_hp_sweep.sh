...
# Usage:
#
#  ./research/synthetic_data/mr_mtl/run_hp_sweep.sh \
#   path_to_config.yaml \
...
# Example:
# ./research/synthetic_data/mr_mtl/run_hp_sweep.sh \
#   research/synthetic_data/mr_mtl/config.yaml \
#   research/synthetic_data/mr_mtl \
...
for ALPHA_BETA_VALUE in "${ALPHA_BETA_VALUES[@]}"; do
  ...
  do
    ...
    do
      EXPERIMENT_NAME="lr_${LR_VALUE}_alpha_beta_${ALPHA_BETA_VALUE}_lam_${LAM_VALUE}"
      ...
      SBATCH_COMMAND="research/synthetic_data/mr_mtl/run_fold_experiment.slrm \
        ${SERVER_CONFIG_PATH} \
