...
do
  ...
  do
    EXPERIMENT_NAME="ex_per_${EXCHANGE_PERCENTAGE}_lr_${LR_VALUE}"
    ...
    SBATCH_COMMAND="research/ag_news/dynamic_layer_exchange/run_fold_experiment.slrm \
      ${SERVER_CONFIG_PATH} \
