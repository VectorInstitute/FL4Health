...
# HYPERPARAMETER_VALUES=(0.0001 0.0003 0.0005 0.0007 0.0009)
# shift 4 
# HYPERPARAMETER_VALUES=("$@")

DEFAULT_LR=0.001

if [ "$HYPERPARAMETER_NAME" = "noise_scale" ]; then
  ALIAS="noise"
else 
...
do
  ...
  SBATCH_COMMAND="research/flamby_distributed_dp/fed_tcga_brca/run_fold_experiment.slrm \
    ${SERVER_CONFIG_PATH} \
