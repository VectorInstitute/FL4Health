...
class Fed_TCGA_BRCA_Client(DPScaffoldLoggingClient):

    def set_task_name(self):
        self.task_name = "Fed_TCGA_BRCA Local"
        return self.task_name

    def get_data_loaders(self, config: Config) -> Tuple[DataLoader, DataLoader]:

        train_dataset, validation_dataset = construct_fed_tcga_brca_train_val_datasets(self.client_id)
...
if __name__ == "__main__":
    ...
    client = Fed_TCGA_BRCA_Client(data_path=data_path, 
                            metrics=[C_Index('Fed_TCGA_BRCA Local')], 
                            device=DEVICE,
