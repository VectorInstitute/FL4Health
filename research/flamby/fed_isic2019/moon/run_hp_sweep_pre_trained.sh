...
#   research/flamby/fed_isic2019/moonc/ \
...
# Create sweep folder
SWEEP_DIRECTORY="${ARTIFACT_DIR}hp_sweep_results_pre_trained"
...
do
  ...
  SBATCH_COMMAND="research/flamby/fed_isic2019/moon/run_fold_experiment_pre_trained.slrm \
    ${SERVER_CONFIG_PATH} \
