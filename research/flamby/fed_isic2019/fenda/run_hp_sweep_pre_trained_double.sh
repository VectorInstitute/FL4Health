...
# Create sweep folder
SWEEP_DIRECTORY="${ARTIFACT_DIR}hp_sweep_results_pre_trained_double"
...
do
  ...
  SBATCH_COMMAND="research/flamby/fed_isic2019/fenda/run_fold_experiment_pre_trained_double.slrm \
    ${SERVER_CONFIG_PATH} \
