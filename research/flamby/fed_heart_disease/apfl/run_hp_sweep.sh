...
ALPHA_LR_VALUES=( 0.0001 0.001 0.01 0.1 1.0 )
# FedHeartDisease LR Hyperparameters from paper are not suitable for AdamW
...
for ALPHA_LR_VALUE in "${ALPHA_LR_VALUES[@]}";
do
  for LR_VALUE in "${LR_VALUES[@]}";
  do
    EXPERIMENT_NAME="alpha_lr_${ALPHA_LR_VALUE}_lr_${LR_VALUE}"
    ...
    SBATCH_COMMAND="research/flamby/fed_heart_disease/apfl/run_fold_experiment.slrm \
      ${SERVER_CONFIG_PATH} \
