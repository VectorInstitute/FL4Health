...
# FedHeartDisease Server LR Hyperparameters from paper are not suitable for AdamW
...
do
  ...
  do
    ...
    SBATCH_COMMAND="research/flamby/fed_heart_disease/scaffold/run_fold_experiment.slrm \
      ${SERVER_CONFIG_PATH} \
