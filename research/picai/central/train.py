...
import torch
from research.picai.augmentations import apply_augmentations
from research.picai.data_utils import prepare_datagens
from picai_baseline.unet.training_setup.loss_functions.focal import FocalLoss
from research.picai.model_utils import get_unet
from research.picai.training import resume_or_restart_training, optimize_model, validate_model
...
def main():
    ...
    for f in args.folds:
        ...
        # model definition
        model = get_unet(args=args, device=device)
