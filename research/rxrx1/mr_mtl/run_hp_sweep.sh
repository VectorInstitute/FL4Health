...
# Usage:
#
#  ./research/rxrx1/mr_mtl/run_hp_sweep.sh \
#   path_to_config.yaml \
...
# Example:
# ./research/rxrx1/mr_mtl/run_hp_sweep.sh \
#   research/rxrx1/mr_mtl/config.yaml \
#   research/rxrx1/mr_mtl \
#   /datasets/rxrx1 \
...
do
  ...
  do
    ...
    SBATCH_COMMAND="research/rxrx1/mr_mtl/run_fold_experiment.slrm \
      ${SERVER_CONFIG_PATH} \
