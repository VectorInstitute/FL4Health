...
# Usage:
#
#  ./research/rxrx1/ditto_mkmmd/run_hp_sweep.sh \
#   path_to_config.yaml \
...
# Example:
# ./research/rxrx1/ditto_mkmmd/run_hp_sweep.sh \
#   research/rxrx1/ditto_mkmmd/config.yaml \
#   research/rxrx1/ditto_mkmmd \
#   /datasets/rxrx1 \
    ...
    do
      ...
      do
        ...
        do
          ...
          SBATCH_COMMAND="research/rxrx1/ditto_mkmmd/run_fold_experiment.slrm \
            ${SERVER_CONFIG_PATH} \
