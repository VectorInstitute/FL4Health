...
def test_getting_parameters(get_fenda_client: FendaConstClient) -> None:  # noqa
...
@pytest.mark.parametrize("local_module,global_module,head_module", [(FeatureCnn(), FeatureCnn(), FendaHeadCnn())])
def test_setting_global_model(get_fenda_client: FendaConstClient) -> None:  # noqa
    torch.manual_seed(42)
    fenda_client = get_fenda_client
...
@pytest.mark.parametrize("local_module,global_module,head_module", [(FeatureCnn(), FeatureCnn(), FendaHeadCnn())])
def test_setting_old_models(get_fenda_client: FendaConstClient) -> None:  # noqa
    torch.manual_seed(42)
    fenda_client = get_fenda_client
...
@pytest.mark.parametrize("local_module,global_module,head_module", [(FeatureCnn(), FeatureCnn(), FendaHeadCnn())])
def test_computing_contrastive_loss(get_fenda_client: FendaConstClient) -> None:  # noqa
    torch.manual_seed(42)
    fenda_client = get_fenda_client
...
@pytest.mark.parametrize("local_module,global_module,head_module", [(FeatureCnn(), FeatureCnn(), FendaHeadCnn())])
def test_computing_loss(get_fenda_client: FendaConstClient) -> None:  # noqa
    torch.manual_seed(42)
    fenda_client = get_fenda_client
    fenda_client.temperature = 0.5
