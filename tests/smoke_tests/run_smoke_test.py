...
if __name__ == "__main__":
        ...
        run_smoke_test(
            ...
            client_metrics_checkers=[
                LossChecker(
                    ...
                    checkpoint_loss=1.0138,
                    backward_loss=1.0138,
                    proximal_loss=0.0,
                ),
                LossChecker(
                    metric_type=MetricType.VALIDATION,
                    checkpoint_loss=0.8317,
                    backward_loss=0.8317,
                    proximal_loss=0.0,
                ),
                AccuracyChecker(MetricType.TRAINING, 0.6781),
                AccuracyChecker(MetricType.VALIDATION, 0.787),
            ],
            server_metrics_checkers=[
                LossChecker(loss=1.9934),
                LossChecker(loss=1.2648),
                LossChecker(loss=0.8317),
                AccuracyChecker(MetricType.TRAINING, 0.2031),
                AccuracyChecker(MetricType.TRAINING, 0.5062),
                AccuracyChecker(MetricType.TRAINING, 0.67812),
                AccuracyChecker(MetricType.VALIDATION, 0.4834),
                AccuracyChecker(MetricType.VALIDATION, 0.6102),
    ...
    loop.run_until_complete(
        run_smoke_test(
            ...
            seed=42,
            client_metrics_checkers=[
                LossChecker(metric_type=MetricType.TRAINING, checkpoint_loss=2.1390, backward_loss=2.13905),
                LossChecker(metric_type=MetricType.VALIDATION, checkpoint_loss=2.2294, backward_loss=2.22946),
                AccuracyChecker(MetricType.TRAINING, 0.3718),
                AccuracyChecker(MetricType.VALIDATION, 0.3906),
            ],
            server_metrics_checkers=[
                LossChecker(loss=2.2803),
                LossChecker(loss=2.2633),
                LossChecker(loss=2.2294),
                AccuracyChecker(MetricType.TRAINING, 0.1890),
                AccuracyChecker(MetricType.TRAINING, 0.3531),
                AccuracyChecker(MetricType.TRAINING, 0.3718),
                AccuracyChecker(MetricType.VALIDATION, 0.1850),
    ...
    loop.run_until_complete(
        run_smoke_test(
            ...
            client_metrics_checkers=[
                LossChecker(
                    metric_type=MetricType.TRAINING,
                    checkpoint_loss=0.3044,
                    backward_loss=0.3044,
                    global_loss=0.2709,
                    local_loss=0.4339,
                ),
                LossChecker(
                    metric_type=MetricType.VALIDATION,
                    checkpoint_loss=0.7558,
                    backward_loss=0.7558,
                    global_loss=0.5035,
                    local_loss=1.7347,
                ),
                AccuracyChecker(MetricType.TRAINING, 0.8953, MetricScope.PERSONAL),
                AccuracyChecker(MetricType.TRAINING, 0.8968, MetricScope.GLOBAL),
                AccuracyChecker(MetricType.TRAINING, 0.8671, MetricScope.LOCAL),
                AccuracyChecker(MetricType.VALIDATION, 0.7509, MetricScope.PERSONAL),
                AccuracyChecker(MetricType.VALIDATION, 0.8454, MetricScope.GLOBAL),
                AccuracyChecker(MetricType.VALIDATION, 0.5494, MetricScope.LOCAL),
            ],
            server_metrics_checkers=[
                LossChecker(loss=1.3477),
                LossChecker(loss=0.6121),
                LossChecker(loss=0.7558),
                AccuracyChecker(MetricType.TRAINING, 0.6703, MetricScope.PERSONAL),
                AccuracyChecker(MetricType.TRAINING, 0.8781, MetricScope.PERSONAL),
                AccuracyChecker(MetricType.TRAINING, 0.8953, MetricScope.PERSONAL),
                AccuracyChecker(MetricType.TRAINING, 0.7015, MetricScope.GLOBAL),
                AccuracyChecker(MetricType.TRAINING, 0.8828, MetricScope.GLOBAL),
                AccuracyChecker(MetricType.TRAINING, 0.8968, MetricScope.GLOBAL),
                AccuracyChecker(MetricType.TRAINING, 0.5312, MetricScope.LOCAL),
                AccuracyChecker(MetricType.TRAINING, 0.8453, MetricScope.LOCAL),
                AccuracyChecker(MetricType.TRAINING, 0.8671, MetricScope.LOCAL),
                AccuracyChecker(MetricType.VALIDATION, 0.7069, MetricScope.PERSONAL),
                AccuracyChecker(MetricType.VALIDATION, 0.7936, MetricScope.PERSONAL),
                AccuracyChecker(MetricType.VALIDATION, 0.7509, MetricScope.PERSONAL),
                AccuracyChecker(MetricType.VALIDATION, 0.6961, MetricScope.GLOBAL),
                ...
                AccuracyChecker(MetricType.VALIDATION, 0.7609, MetricScope.LOCAL),
                AccuracyChecker(MetricType.VALIDATION, 0.5494, MetricScope.LOCAL),
            ],
        )
    )
