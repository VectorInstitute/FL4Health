    ...
    loop.run_until_complete(
        run_smoke_test(
            ...
            client_metrics_checkers=[
                ...
                LossChecker(0.0, LossType.PROXIMAL, MetricType.TRAINING),
            ...
            server_metrics_checkers=[
                ...
                AccuracyChecker(0.67812, MetricType.TRAINING),
    ...
    loop.run_until_complete(
        run_smoke_test(
            ...
            client_metrics_checkers=[
                ...
                LossChecker(2.13905, LossType.BACKWARD, MetricType.TRAINING),
                LossChecker(2.2294, LossType.CHECKPOINT, MetricType.VALIDATION),
                LossChecker(2.22946, LossType.BACKWARD, MetricType.VALIDATION),
