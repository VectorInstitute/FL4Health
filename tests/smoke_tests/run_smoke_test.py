...
if __name__ == "__main__":
        ...
        run_smoke_test(
            ...
            client_metrics_checkers=[
                LossChecker(
                    ...
                    checkpoint_loss=1.01385,
                    backward_loss=1.01385,
                    proximal_loss=0.0,
                ),
                LossChecker(
                    metric_type=MetricType.VALIDATION,
                    checkpoint_loss=0.83173,
                    backward_loss=0.83173,
                    proximal_loss=0.0,
                ),
                AccuracyChecker(MetricType.TRAINING, 0.67812),
                AccuracyChecker(MetricType.VALIDATION, 0.7876),
            ],
            server_metrics_checkers=[
                LossChecker(loss=1.99343),
                LossChecker(loss=1.26488),
                LossChecker(loss=0.83173),
                AccuracyChecker(MetricType.TRAINING, 0.20312),
                AccuracyChecker(MetricType.TRAINING, 0.50625),
                AccuracyChecker(MetricType.TRAINING, 0.678125),
                AccuracyChecker(MetricType.VALIDATION, 0.48346),
                AccuracyChecker(MetricType.VALIDATION, 0.61026),
                AccuracyChecker(MetricType.VALIDATION, 0.7876),
            ],
        )
    )
    loop.run_until_complete(
        run_smoke_test(
            ...
            seed=42,
            client_metrics_checkers=[
                LossChecker(metric_type=MetricType.TRAINING, checkpoint_loss=2.13905, backward_loss=2.13905),
                LossChecker(metric_type=MetricType.VALIDATION, checkpoint_loss=2.22946, backward_loss=2.22946),
                AccuracyChecker(MetricType.TRAINING, 0.37187),
                AccuracyChecker(MetricType.VALIDATION, 0.39066),
            ],
            server_metrics_checkers=[
                LossChecker(loss=2.28030),
                LossChecker(loss=2.26336),
                LossChecker(loss=2.22946),
                AccuracyChecker(MetricType.TRAINING, 0.18906),
                AccuracyChecker(MetricType.TRAINING, 0.35312),
                AccuracyChecker(MetricType.TRAINING, 0.37187),
                AccuracyChecker(MetricType.VALIDATION, 0.18506),
    ...
    loop.run_until_complete(
        run_smoke_test(
            ...
            client_metrics_checkers=[
                LossChecker(
                    metric_type=MetricType.TRAINING,
                    checkpoint_loss=0.30444,
                    backward_loss=0.30444,
                    global_loss=0.27094,
                    local_loss=0.43397,
                ),
                LossChecker(
                    metric_type=MetricType.VALIDATION,
                    checkpoint_loss=0.75586,
                    backward_loss=0.75586,
                    global_loss=0.50355,
                    local_loss=1.73477,
                ),
                AccuracyChecker(MetricType.TRAINING, 0.89531, MetricScope.PERSONAL),
                AccuracyChecker(MetricType.TRAINING, 0.89687, MetricScope.GLOBAL),
                AccuracyChecker(MetricType.TRAINING, 0.86718, MetricScope.LOCAL),
                AccuracyChecker(MetricType.VALIDATION, 0.75093, MetricScope.PERSONAL),
                AccuracyChecker(MetricType.VALIDATION, 0.84546, MetricScope.GLOBAL),
                AccuracyChecker(MetricType.VALIDATION, 0.54946, MetricScope.LOCAL),
            ],
            server_metrics_checkers=[
                LossChecker(loss=1.34774),
                LossChecker(loss=0.61218),
                LossChecker(loss=0.75586),
                AccuracyChecker(MetricType.TRAINING, 0.67031, MetricScope.PERSONAL),
                AccuracyChecker(MetricType.TRAINING, 0.87812, MetricScope.PERSONAL),
                AccuracyChecker(MetricType.TRAINING, 0.89531, MetricScope.PERSONAL),
                AccuracyChecker(MetricType.TRAINING, 0.70156, MetricScope.GLOBAL),
                AccuracyChecker(MetricType.TRAINING, 0.88281, MetricScope.GLOBAL),
                AccuracyChecker(MetricType.TRAINING, 0.89687, MetricScope.GLOBAL),
                AccuracyChecker(MetricType.TRAINING, 0.53125, MetricScope.LOCAL),
                AccuracyChecker(MetricType.TRAINING, 0.84531, MetricScope.LOCAL),
                AccuracyChecker(MetricType.TRAINING, 0.86718, MetricScope.LOCAL),
                AccuracyChecker(MetricType.VALIDATION, 0.70693, MetricScope.PERSONAL),
                AccuracyChecker(MetricType.VALIDATION, 0.7936, MetricScope.PERSONAL),
                AccuracyChecker(MetricType.VALIDATION, 0.75093, MetricScope.PERSONAL),
                AccuracyChecker(MetricType.VALIDATION, 0.69613, MetricScope.GLOBAL),
                AccuracyChecker(MetricType.VALIDATION, 0.7956, MetricScope.GLOBAL),
                AccuracyChecker(MetricType.VALIDATION, 0.84546, MetricScope.GLOBAL),
                AccuracyChecker(MetricType.VALIDATION, 0.6716, MetricScope.LOCAL),
                AccuracyChecker(MetricType.VALIDATION, 0.76093, MetricScope.LOCAL),
                AccuracyChecker(MetricType.VALIDATION, 0.54946, MetricScope.LOCAL),
            ],
        )
    )
