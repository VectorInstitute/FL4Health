...
class BasicClient(NumpyFlClient):
    ...
    def predict(self, input: torch.Tensor) -> Tuple[Dict[str, torch.Tensor], Dict[str, torch.Tensor]]:
        ...
        - index 0: dict of str and torch.Tensor containing predictions generated by the model to be evaluated.
        - index 1: dict of str and torch.Tensor contain intermediate activations of model
                   useful for calculating losses (ie MOON)
