...
nohup python -m examples.vae_dim_example.server --config_path ${SERVER_CONFIG_PATH} > ${SERVER_LOG_PATH} 2>&1 &
...
do
    ...
    nohup python -m examples.vae_dim_example.client --dataset_path ${CLIENT_DATA_PATH} > ${CLIENT_LOG_PATH} 2>&1 &
