...
```
python -m examples.dp_fed_examples.client_level_dp_weighted.server --config_path /path/to/config.yaml
```
...
```
python -m examples.dp_fed_examples.client_level_dp_weighted.client --dataset_path /path/to/data
```
