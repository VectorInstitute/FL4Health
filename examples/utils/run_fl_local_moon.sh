...
config_path="examples/moon_example/config.yaml"
dataset_path="examples/datasets/mnist_data/"
server_output_file="examples/moon_example/server.out"
client_output_folder="examples/moon_example/"
...
nohup python -m examples.moon_example.server --config_path ${config_path} > ${server_output_file} 2>&1 &
...
do
    ...
    nohup python -m examples.moon_example.client --dataset_path ${dataset_path} > ${client_log_path} 2>&1 &
done
