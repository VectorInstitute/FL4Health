...
config_path="examples/ditto_example/config.yaml"
dataset_path="examples/datasets/mnist_data/"
server_output_file="examples/ditto_example/server.out"
client_output_folder="examples/ditto_example/"
...
nohup python -m examples.ditto_example.server --config_path ${config_path} > ${server_output_file} 2>&1 &
...
do
    ...
    nohup python -m examples.ditto_example.client \
        --dataset_path ${dataset_path} \
        --name "client_${i}" > ${client_log_path} 2>&1 &
done
